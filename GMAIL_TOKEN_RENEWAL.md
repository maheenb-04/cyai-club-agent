...
3. Click the gear icon (top right) then check "Use your own OAuth credentials"
...
5. Close settings. On the left side, find "Gmail API v1" in the list, expand it, and check the box for this exact scope: https://www.googleapis.com/auth/gmail.send
6. Click "Authorize APIs"
7. Log in as cyai.club@gmail.com, click through the "unverified app" warning (Advanced, then Go to CYAI Backend, unsafe) - this is expected and safe.
